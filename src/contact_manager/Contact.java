...
public class Contact {
  ...
  // Returns a formatted multi-line string representation of the contact for console display.
  public String toString() {
    return """
        ...
        Company: %s
        Birthday: %s
        """.formatted(lastname, firstname, phoneNumber, email, address, city, state, zipCode, country, company,
        birthday);
  }
}