...
public class CAContactSeeder {
        ...
        public static void seed(CAContactManager contactManager) {
                contactManager.addCaContact(
                                new CAContact("Deleaner", "Helena", "hdeleaner@example.com", "01-23-45-67-89",
                                                "Creative",
                                                "Art Director",
                ...
                contactManager
                                .addCaContact(new CAContact("Dubois", "Pierre", "pdubois@example.com", "01-98-76-54-32",
                                                "Creative",
                                                "Graphic Designer",
                                                ...
                                                new CAAddress("34", "Avenue des Champs-Élysées", "Paris", "75008",
                                                                "France")));
                contactManager.addCaContact(
                                new CAContact("Lemoine", "Sophie", "slemoine@example.com", "01-56-78-90-12", "Creative",
                                                "Copywriter",
                                                ...
                                                new CAAddress("56", "Boulevard Saint-Michel", "Paris", "75005",
                                                                "France")));

                contactManager.addCaContact(
                                new CAContact("Martin", "Luc", "lmartin@example.com", "01-34-56-78-90",
                                                "Account Management",
                                                "Account Manager",
